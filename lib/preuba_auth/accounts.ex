defmodule PreubaAuth.Accounts do
  @moduledoc """
  This is the Accounts Context
  """

  import Ecto.Query, warn: false
  alias PreubaAuth.Repo

  alias PreubaAuth.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  UPDATING THE USER EMAIL USING A GIVEN TOKEN
  """
  ...
  def deliver_update_email_instructions(%User{} = user, current_email, update_email_url_fun) when is_function(update_email_url_fun, 1) do
  ...
  @doc """
  GETTING THE USER WITH THE GIVEN SIGNED TOKEN
  """
  ...
  @doc """
  DELIVERS CONFIRMATION EMAIL INSTRUCTIONS TO THE USER
  """

  def deliver_user_confirmation_instructions(%User{} = user, confirmation_url_fn) when is_function(confirmation_url_fn, 1) do
  ...
  IF THE TOKEN MATCHES, THE USER USER ACCOUNT IS MARKED AS CONFIRMED AND THE TOKEN IS DELETED.
  """
